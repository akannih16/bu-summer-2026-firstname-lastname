...
/* 
    ...
    Output: 
        name Akanni Hernandez
        grade 11th
        What you are looking forward to in this class? Learning Java Script
*/

let name = "Akanni Hernandez";
let grade = "11th";
let lookingForward = "Learning Java Script";    

function question1(name, grade, lookingForward) {  

    console.log(`Name: ${name}`);

    console.log(`Grade: ${grade}`);

    console.log(`Looking forward to: ${lookingForward}`);
...
function question5(celsius) {  
    ...
    question5(0);    // Output: 32
    question5(100);  // Output: 212
    question5(32);   // Output: 89.6
    question5(60);   // Output: 140
...
function question6(inchesToFeet) {  
    // TO-DO: COMPLETE ME!
    // PLEASE PRINT THE RESULT IN THIS FUNCTION
...
question6(12);    // Output: 1
question6(36);    // Output: 3
question6(1);     // Output: 0.08
question6(5);     // Output: 0.41
